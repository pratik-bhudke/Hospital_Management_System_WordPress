		...
		<div class='footer_txt'>
			<div class='container'>
				...
				<?php /* 
					...
					You can buy this theme without footer links online at http://smthemes.com/buy/garden/
				*/ ?>
				<div class='smthemes'>Designed by <a href='http://www.raspberryketoneinfo.co.uk' target='_blank'>raspberry ketones uk</a>, thanks to: <a href='http://www.hcginjectionsmain.com' target='_blank'>hcg injections main</a>, <a href='http://www.r4-usa.com' target='_blank'>r4 3ds card</a> and <a href='http://www.hcgdropinfo.com' target='_blank'>hcgdropinfo.com</a></div>
			</div>
		</div>
		<?php wp_footer(); ?>
	</div> <?php //footer ?>
