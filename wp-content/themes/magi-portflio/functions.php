...
$options = array (
    ...
    array(	"name" => "Header Banner (468x60 px)",
            ...
            "type" => "textarea",
			"std" => '<a href="http://secure.hostgator.com/~affiliat/cgi-bin/affiliates/clickthru.cgi?id=alabuba-"><img src="http://tracking.hostgator.com/img/Shared/468x60.gif" style="border: 0;" alt="Hostgator" /></a>'
			),	
...
'
        ...
        "type" => "textarea",
		"std" => '<a href="http://secure.hostgator.com/~affiliat/cgi-bin/affiliates/clickthru.cgi?id=alabuba-"><img src="http://tracking.hostgator.com/img/Shared/160x600.gif" style="border: 0;" alt="Hosting" /></a>'
		),	
